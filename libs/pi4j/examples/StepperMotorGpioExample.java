...
public class StepperMotorGpioExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("<--Pi4J--> GPIO Stepper DcMotor Example ... started.");
        ...
        System.out.println("   DcMotor FORWARD for 2038 steps.");
        motor.step(2038);
        System.out.println("   DcMotor STOPPED for 2 seconds.");
        Thread.sleep(2000);

        // test motor control : STEPPING REVERSE
        System.out.println("   DcMotor REVERSE for 2038 steps.");
        motor.step(-2038);
        System.out.println("   DcMotor STOPPED for 2 seconds.");
        Thread.sleep(2000);

        // test motor control : ROTATE FORWARD
        System.out.println("   DcMotor FORWARD for 2 revolutions.");
        motor.rotate(2);
        System.out.println("   DcMotor STOPPED for 2 seconds.");
        Thread.sleep(2000);

        // test motor control : ROTATE REVERSE
        System.out.println("   DcMotor REVERSE for 2 revolutions.");
        motor.rotate(-2);
        System.out.println("   DcMotor STOPPED for 2 seconds.");
        Thread.sleep(2000);

        // test motor control : TIMED FORWARD
        System.out.println("   DcMotor FORWARD for 5 seconds.");
        motor.forward(5000);
        System.out.println("   DcMotor STOPPED for 2 seconds.");
        Thread.sleep(2000);

        // test motor control : TIMED REVERSE
        System.out.println("   DcMotor REVERSE for 5 seconds.");
        motor.reverse(5000);
        System.out.println("   DcMotor STOPPED for 2 seconds.");
        Thread.sleep(2000);

        // test motor control : ROTATE FORWARD with different timing and sequence
        System.out.println("   DcMotor FORWARD with slower speed and higher torque for 1 revolution.");
        motor.setStepSequence(double_step_sequence);
        motor.setStepInterval(10);
        motor.rotate(1);
        System.out.println("   DcMotor STOPPED.");
